class ScoresController < ApplicationController
  ...
  def generate
    ...
    @professors = Professor.base.base_course_professors.base_course_professor_users.base_courses.with_course_professors.with_course_professor_users.with_courses
